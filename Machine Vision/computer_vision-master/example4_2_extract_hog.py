...
# ? WinSize : ขนาดของ Image
# ? BlockSize : ขนาดของ Block
# ? BlockStride : ระยะห่างระหว่าง Block
# ? CellSize : ขนาดของ Cell
# ? NBins : จำนวนของ Bin
...
print(features_train)  # ? (number, features)
print(label_train)  # ? (number, labels)
plt.show()
cv2.waitKey(0)
