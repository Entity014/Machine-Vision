...
# glcm = graycomatrix(im_gray, [5], [0], 256, symmetric=True, normed=True) # ? img, offset, direction, levels, symmetric, normed
glcm = graycomatrix(
    im_gray, [5, 10, 15], [0, np.pi / 2], 256, symmetric=True, normed=True
)
print("GLCM Shape")
print(glcm.shape)  # ? (256, 256, 3 : offset , 2 : direction)
